...
vcf.fn <- "C:/Users/ForsdickN/OneDrive - MWLR/Documents/Weta-GBS/2024-11-01-Results/weta.snpmiss60.mac3.thin.vcf"

#file.size(vcf.fn)
#vcf_test1 <- read.vcfR(vcf.fn)
snpgdsVCF2GDS("C:/Users/ForsdickN/OneDrive - MWLR/Documents/Weta-GBS/2024-11-01-Results/weta.snpmiss60.mac3.thin.vcf", "test.gds", method="biallelic.only")
...
#pop_code <- scan("C:/Users/ForsdickN/OneDrive - MWLR/Documents/Weta-GBS/2024-11-01-Results/weta.snpmiss60.mac3.thin-pop.txt",
#                 what=character())
pop_code <- read.delim("C:/Users/ForsdickN/OneDrive - MWLR/Documents/Weta-GBS/2024-11-01-Results/weta.snpmiss60.mac3.thin-pop.txt", sep="\t", header=F)
table(pop_code)
