...
ref=$refdir$reffile
samplist=/nesi/project/ga03186/ref/B1_filelist.txt
...
#INDIR=/nesi/nobackup/ga03186/Weta_GBS_Batchcombo/
#OUTSAM=/nesi/nobackup/ga03186/Weta_GBS_Batchcombo/02_stacks_trim_map/SAM/
#OUTBAM=/nesi/nobackup/ga03186/Weta_GBS_Batchcombo/02_stacks_trim_map/BAM/
#OUTSORT=/nesi/nobackup/ga03186/Weta_GBS_Batchcombo/03_stacks_sorted/
###########
...
bowtie2 --very-sensitive-local --no-unal --threads 8 -x $refdir$reffile -U ${INDIR}${QUERY}_trimmed.fq.gz -S ${OUTSAM}${QUERY}.sam
...
echo "% mapped $perc_mapped" >> ${OUTSORT}B1_bwa_mapping_stats.txt
